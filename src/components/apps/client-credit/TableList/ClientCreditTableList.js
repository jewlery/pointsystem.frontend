...
import {deleteCredit, exportCredits, fetchCredits} from "../../../../store/apps/client-credit/clientCreditSlice";
import CreateClientCreditDialog from "../../../modals/client-credit/CreateClientCreditDialog/CreateClientCreditDialog";
import EditClientCreditDialog from "../../../modals/client-credit/EditClientCreditDialog/EditClientCreditDialog";
import FilterClientCreditDialog from "../../../modals/client-credit/FilterClientCreditDialog/FilterClientCreditDialog";
...
const headCells = [
    ...
    {id: 'type', numeric: false, disablePadding: false, label: 'Statut de paiement'},
...
const ClientCreditTableList = () => {
    ...
    const credits = useSelector((state) => state.clientCreditReducer.credits);
    const totalCredits = useSelector((state) => state.clientCreditReducer.total);
                            ...
                            {credits.map((credit) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <TableCell>{credit.client_name}</TableCell>
                                        <TableCell>
                                            <Tooltip title="Edit">
                                                <IconButton
                                                    color="primary"
...
export default ClientCreditTableList;
